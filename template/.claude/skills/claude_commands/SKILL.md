...
- `references/frontmatter-reference.md` — Complete frontmatter field docs with all options
- `references/command-patterns.md` — Ready-to-use command examples by category
- `templates/command-template.md` — Annotated template for writing a new command from scratch
