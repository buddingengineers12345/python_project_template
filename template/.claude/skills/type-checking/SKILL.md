...
name: type-checking
description: >-
  Configure and debug basedpyright type checking: common errors, fix strategies,
  and standard mode settings. Use this skill when debugging type errors,
  configuring basedpyright, or understanding type annotations. Trigger on:
  type checking, type annotation, basedpyright, typing errors, mypy, type
  error, Protocol, Union, Generic, or any request to fix type issues in
  Python. Do NOT use for type annotation style guidance; python-code-reviewer
  handles type style issues.
model: haiku
---
